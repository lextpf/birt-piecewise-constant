 ...
 * {@link StepExpansion#owner}.</li>
 * </ul>
 */
public final class StepPointExpander {

	/**
	 * Only static members.
	 */
	private StepPointExpander() {
	}
	 ...
	 */
	public static StepExpansion expand(double[] base, double[] value, boolean[] isNull, StepMode mode,
	...
	private static final class Vertices {
		 ...
		 */
		StepExpansion trim() {
			return new StepExpansion(Arrays.copyOf(base, size), Arrays.copyOf(value, size), Arrays.copyOf(owner, size),
