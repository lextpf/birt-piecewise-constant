...
public enum StepMode implements Enumerator {
	...
	// EMF stores this value in the meta model.
	...
	// The lookup methods of this class read this array.
	private static final StepMode[] VALUES_ARRAY = { AFTER_LITERAL, BEFORE_LITERAL, CENTER_LITERAL, };

	// EMF reads this list when it builds the enumeration of the meta model.
	...
	// Only the literal declarations above can call this constructor.
	...
	// The EMF serializer writes this string into the chart XML.
	@Override
